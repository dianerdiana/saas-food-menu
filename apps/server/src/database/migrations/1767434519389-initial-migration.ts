...
export class InitialMigration1767434519389 implements MigrationInterface {
    name = 'InitialMigration1767434519389'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "recommendations" ("id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "created_by" uuid, "updated_by" uuid, "deleted_by" uuid, "name" character varying(255) NOT NULL, "status" character varying(255) NOT NULL DEFAULT 'ACTIVE', "store_id" uuid NOT NULL, CONSTRAINT "PK_23a8d2db26db8cabb6ae9d6cd87" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product_recommendations" ("id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "created_by" uuid, "updated_by" uuid, "deleted_by" uuid, "product_id" uuid NOT NULL, "recommendation_id" uuid NOT NULL, CONSTRAINT "PK_34c228b0d96e8ff52db667b4c22" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "recommendations" ADD CONSTRAINT "FK_653f4f5b366fc6f4811b1528436" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "recommendations" ADD CONSTRAINT "FK_1a6120e5ed463125ccdd64c11b5" FOREIGN KEY ("updated_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "recommendations" ADD CONSTRAINT "FK_7bf35cfb93123313aaabafa84ff" FOREIGN KEY ("deleted_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "recommendations" ADD CONSTRAINT "FK_4eb46977168b68f94a98427ebd5" FOREIGN KEY ("store_id") REFERENCES "stores"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "recommendations" DROP CONSTRAINT "FK_4eb46977168b68f94a98427ebd5"`);
        await queryRunner.query(`ALTER TABLE "recommendations" DROP CONSTRAINT "FK_7bf35cfb93123313aaabafa84ff"`);
        await queryRunner.query(`ALTER TABLE "recommendations" DROP CONSTRAINT "FK_1a6120e5ed463125ccdd64c11b5"`);
        await queryRunner.query(`ALTER TABLE "recommendations" DROP CONSTRAINT "FK_653f4f5b366fc6f4811b1528436"`);
