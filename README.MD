...
- `POST /api/v1/categories` - Create new store
- `GET /api/v1/categories/:id` - Get store data by id
- `PUT /api/v1/categories/:id` - Update store data by id
- `DELETE /api/v1/categories/:id` - Delete store by id
